"""
Django settings for DjangoRESTProject_practice project.
...
ROOT_URLCONF = 'DjangoRESTProject_practice.urls'
...
WSGI_APPLICATION = 'DjangoRESTProject_practice.wsgi.application'
